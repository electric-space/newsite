...
if ( ! function_exists( 'newsite_setup' ) ) :
	...
	function newsite_setup() {
		...
		register_nav_menus( array(
			'primary_menu' => esc_html__( 'Primary menu', 'newsite' ),
			'footer_menu' => esc_html__( 'Footer menu', 'newsite' ),
		) );
...
function newsite_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'newsite_content_width', 640 );
}
...
function newsite_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'newsite' ),
...
function newsite_scripts() {
	...
	wp_enqueue_script( "newsite-uikt", '//cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-rc.20/js/uikit.min.js', array('jquery'), '3.0.0.20', 1);
	wp_enqueue_script( "newsite-uikt-icons", '//cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-rc.20/js/uikit-icons.min.js', array('jquery'), '3.0.0.20', 1);
    wp_enqueue_script( "newsite-webfont", '//ajax.googleapis.com/ajax/libs/webfont/1.6.26/webfont.js', 0, 0, 0);
	wp_enqueue_script( "newsite-main", get_template_directory_uri().'/js/main.js', array('jquery'), 0, 1);
	...
	wp_enqueue_script( 'newsite-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'newsite-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
